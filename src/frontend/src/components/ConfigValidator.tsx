...
function validateEnvironment(): ValidationResult {
  ...
  if (!network) {
    ...
    warnings.push(
      `Unexpected VITE_DFX_NETWORK value: "${network}". Expected "ic" or "local".`,
    );
  }
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-red-200 mb-3">
              Critical environment variables are missing. The application cannot
              function properly without these settings.
            </p>
            ...
            <div className="bg-black/40 p-4 rounded border border-red-500/30">
              <h3 className="text-red-100 font-bold mb-2 text-sm">
                QUICK FIX:
              </h3>
