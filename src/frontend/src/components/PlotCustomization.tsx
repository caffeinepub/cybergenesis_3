...
export default function PlotCustomization({
  selectedLandIndex,
}: PlotCustomizationProps) {
  ...
  React.useEffect(() => {
    if (selectedLand) {
      ...
      setDecorationUrl(
        typeof selectedLand.decorationURL === "string"
          ? selectedLand.decorationURL
          : "",
      );
    }
  }, [selectedLand]);
