...
export function DeploymentVerification() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: intentional - checkHealth is stable
  useEffect(() => {
    checkHealth(true);
        ...
        <div className="space-y-2">
          ...
          <div className="p-3 rounded-lg bg-black/30 border border-green-500/20">
            ...
            <div className="text-xs text-gray-500 mt-2">
              ...
              <br />✓ All type definitions synchronized
              <br />✓ Transform function included for HTTP outcalls
            </div>
          </div>
        </div>
        ...
        {canisters.every((c) => c.status === "healthy") && (
          <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/30">
            ...
            <div className="text-xs text-gray-400 mt-2">
              Both Land Canister and Asset Canister are HEALTHY and fully
              operational.
            </div>
          </div>
        )}
