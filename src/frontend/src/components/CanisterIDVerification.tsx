  ...
  const canisters: CanisterIDInfo[] = [
    {
      ...
      currentId:
        import.meta.env.VITE_LAND_CANISTER_ID ||
    ...
    },
    {
      ...
      currentId:
        import.meta.env.VITE_MARKETPLACE_CANISTER_ID ||
        import.meta.env.CANISTER_ID_MARKETPLACE ||
        "не настроено",
      isCorrect: false,
    },
    {
      ...
      currentId:
        ...
        import.meta.env.CANISTER_ID_GOVERNANCE ||
        "не настроено",
      isCorrect: false,
    },
  ];
              ...
              <div className="flex-1">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <div className="flex gap-2">
                    ...
                    <code
                      className={`font-mono ${canister.isCorrect ? "text-green-300" : "text-red-300"}`}
                    >
                      {canister.currentId}
                    </code>
                  </div>
        ...
        {hasErrors && (
          <div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm text-gray-300">
              <li>
                Откройте файл{" "}
                <code className="text-cyan-300 font-mono">frontend/.env</code>
              </li>
              <li>
                Обновите неправильные идентификаторы канистр на правильные
                значения
              </li>
              <li>
                Сохраните файл и пересоберите проект:{" "}
                <code className="text-cyan-300 font-mono">npm run build</code>
              </li>
              <li>
                Перезапустите приложение:{" "}
                <code className="text-cyan-300 font-mono">npm start</code>
              </li>
            </ol>
          </div>
        )}
        {allCorrect && (
          <div className="mt-6 p-4 bg-green-500/10 border border-green-500/30 rounded-lg">
            ...
            <p className="text-sm text-gray-300">
              Все идентификаторы канистр настроены правильно. Соединение с
              backend должно работать корректно.
            </p>
          </div>
        )}
      </CardContent>
